...
function NavBar(){
    return <div id="navbar"  className="bg-lightgray-500 py-4 px-6 font-[Instrument_Serif]">

        <div className="flex justify-center items-center">
            <hr className="flex-2 h-1 w-full mx-auto bg-gray-100 rounded-sm dark:bg-gray-700"/>
                <Link to="/" className="flex flex-1 justify-center items-center text-[36px] tracking-[3.6px] no-underline text-black">KOL O DOR</Link>
            <hr className="flex-2 h-1 w-full mx-auto bg-gray-100 rounded-sm dark:bg-gray-700"/>
        </div>
        ...
        <div className='flex justify-between items-center text-xl'>
                ...
                <ul className="flex space-x-12 underline underline-offset-4 decoration-2 px-9">
                    ...
                    <li><Link to="/cart" className="text-black no-underline hover:text-amber-600">Cart</Link></li>
                </ul>
